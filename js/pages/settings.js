    ...
    render: function() {
        return `
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div style="display: flex; flex-direction: column; gap: 16px;">
                            ...
                            <button type="button" class="btn btn-secondary btn-block" style="justify-content: flex-start;"
                                    onclick="if(confirm('Yakin ingin menjalankan migrasi database?')) { alert('Migrasi dijalankan'); }">
            ...
            <div class="card" style="margin-top: 24px;">
                ...
                <div class="card-body">
                    <form onsubmit="event.preventDefault(); alert('Pesan test dikirim ke ' + this.phone.value);" style="max-width: 500px;">
